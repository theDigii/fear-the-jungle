...
/** Every string here comes from the backend's Text screen via page.tsx. */
export default function Signup({ label, note, button, communityHead, discordLabel, discordUrl }: SignupProps) {
  ...
  return (
    ...
    <div className="signup">
          <label className="signup-label" htmlFor="email">{label}</label>
        ...
        <div className="community">
          <p className="community-head">{communityHead}</p>
          <a className="discord" href={discordUrl} target="_blank" rel="noopener noreferrer">
